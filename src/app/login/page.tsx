            ...
            <div className="w-full max-w-md space-y-8">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        dasADS — Платформа для рекрутинга
                    </p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    {error && (
                        <div className="text-red-500 text-sm text-center">{error === "Invalid email or password" ? "Неверный email или пароль" : "Произошла ошибка при входе"}</div>
                    )}
